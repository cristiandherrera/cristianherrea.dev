          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="glass p-6 text-center">
                ...
                <p className="text-accent">Modern, responsive applications with cutting-edge technologies</p>
              </div>
              <div className="glass p-6 text-center">
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center">
                  <span className="text-2xl" style={{ color: 'var(--color-primary)' }}>DATA</span>
                ...
                <p className="text-accent">Scalable pipelines and analytics infrastructure</p>
              </div>
              <div className="glass p-6 text-center">
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center">
                ...
                <p className="text-accent">Complete systems from data ingestion to user visualization</p>
              </div>
            </div>
          </div>
        </ScrollReveal>
